...
export function statusResultsUser(diabetes, hypertension, exercise) {
    if ((diabetes === "N") && (hypertension === "N") && (exercise === "N")) {  //A1
        return { resultsUser: "A1" }
    }
    else if ((diabetes === "N") && (hypertension === "N") && (exercise === "Y")) { //A2
        return { resultsUser: "A2" }
    }
