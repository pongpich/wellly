...
class Register extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.statusCheckEmailExist !== statusCheckEmailExist &&
    ...
    if (
      prevProps.statusRegister !== statusRegister &&
                    ...
                    <View style={styles.inputPassword2}>
                      <TextInput
                        style={{
                          width: "100%",
                          height: 56,
                          borderWidth: styleConfirmPassword
                            ? isFocused3
                              ? 2
                              : 1
                            : 2,
                          ...
                          fontFamily: "IBMPlexSansThai-Regular",
                          zIndex: 0,
                          borderColor: styleConfirmPassword
                            ? isFocused3
                              ? colors.persianBlue
                              : colors.grey4
                            : colors.negative1,
                        ...
                        onChangeText={(text) =>
                          this.handleChange("confirm_password", text)
                        }
                        placeholder={
