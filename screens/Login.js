  ...
  render() {
    ...
    return (
      <LinearGradient
        ...
        colors={[colors.primaryBackgroundLogin, "white", "white"]}
        start={{ x: 1, y: 0 }}
        end={{ x: 1, y: 1 }}
      >
          ...
          >
            <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
              <View style={styles.content}>
                <View style={[ComponentsStyle.viewStyle_1, { marginTop: -10 }]}>
                  ...
                  <View style={styles.inputPassword}>
                    {entry === false ? (
                      <TouchableOpacity
                        style={styles.entry}
                        onPress={() => this.handleChangeEntry("entry", true)}
                      >
                        <Image
                      ...
                      <TouchableOpacity
                        style={styles.entry}
                        onPress={() => this.handleChangeEntry("entry", false)}
                      >
                        <Image
                          style={styles.entryImage}
                  ...
                  <View style={styles.buttonTop}>
                    ...
                    <View
                      style={[styles.buttonForgotPassword, { marginTop: 0 }]}
                    >
                      <Pressable
                        onPress={() =>
                ...
                <View
                  style={[
                    ComponentsStyle.viewStyle_2,
                    { flex: 1, justifyContent: "flex-end" },
                  ]}
                >
                  {i18next.language === "th" ? (
                    <Pressable
                      style={styles.buttonThi_eng}
                    ...
                    <Pressable
                      style={styles.buttonThi_eng}
                      onPress={() => i18next.changeLanguage("th")}
                    >
