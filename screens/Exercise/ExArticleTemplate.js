...
class ArticleTemplate extends Component {
  ...
  componentDidMount() {
    ...
    const { statusPags, id, heading, mission_activities } =
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.statusReadExerciseActivty !== statusReadExerciseActivty &&
  ...
  renderCheckArticle() {
    ...
    return (
      <View style={{ flex: 1, marginHorizontal: 16 }}>
        ...
        {(mission_id === "2c_1" || mission_id === "2c_2") &&
          (languages == "th" ? <C2 /> : <C2_eng />)}
        {(mission_id === "3c_1" || mission_id === "3c_2") &&
          (languages == "th" ? <C3 /> : <C3_eng />)}
        {(mission_id === "4c_1" || mission_id === "4c_2") &&
          (languages == "th" ? <C4 /> : <C4_eng />)}
        {(mission_id === "5c_1" || mission_id === "5c_2") &&
          (languages == "th" ? <C5 /> : <C5_eng />)}
        {(mission_id === "6c_1" || mission_id === "6c_2") &&
          (languages == "th" ? <C6 /> : <C6_eng />)}
        {mission_id === "continuous" &&
          (languages == "th" ? <Continuous /> : <Continuous />)}
      </View>
    );
  }
  ...
  missionDataView(data) {
    const { expanded, start, mission_activities, week_in_program, id } =
      this.state;
      ...
      >
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <Image
                source={require("../../assets/images/icon/Firepoint.png")}
        ...
        <List.Section style={{ marginLeft: -16, marginTop: -8, zIndex: 0 }}>
          <List.Accordion
            ...
            title={
              <Text style={styles.titleAccordion}>{t("scoring_criteria")}</Text>
            }
            right={(props) => (
              <List.Icon
                {...props}
              ...
              data.map((item, i) => {
                ...
                return (
                  <View
                    style={{
                      marginLeft: 16,
                      backgroundColor: i % 2 == 0 ? colors.grey7 : colors.grey6,
                      paddingHorizontal: 16,
                      borderTopLeftRadius: index == 1 ? 8 : 0,
                      borderTopRightRadius: index == 1 ? 8 : 0,
                      borderBottomLeftRadius: index == datalength ? 8 : 0,
                      borderBottomRightRadius: index == datalength ? 8 : 0,
                      flexDirection: "row",
                    ...
                    <View style={styles.missionData}>
                      ...
                      <View style={{ flexDirection: "row" }}>
                        {Array.from({ length: maxScore }) &&
                          Array.from({ length: maxScore }).map((item, i) => {
                            return (
                              <Image
                                style={[
                                  i > 0 ? { marginLeft: 4 } : null,
                                  { width: 16, height: 16, marginTop: 8 },
                                ]}
                                source={
                                  score_completed >= ++i
    ...
    return (
      <View style={styles.container}>
        ...
        <Animated.View style={[styles.header, { height: headerHeight }]}>
          <View style={ComponentsStyle.headBox}>
            <View style={ComponentsStyle.areaNumber}>
              <Text style={ComponentsStyle.areaNumberText}>{id}</Text>
            </View>
            <View
              style={[ComponentsStyle.nutritionMission, { paddingRight: 16 }]}
            >
              <Text style={ComponentsStyle.missionHead}>
                {t("exercise_mission")}
              </Text>
              <Text
                style={[ComponentsStyle.missionHeading, { marginRight: 16 }]}
                onTextLayout={this.handleTextLayout} /* numberOfLines={2} */
              >
                {heading}
              </Text>
            </View>
          ...
          <View style={{ marginTop: 0 /*  height: "100%", */ }}>
            ...
            {study && (
              <View
                style={[
                  styles.areaViewText,
                  { marginTop: 30, marginBottom: 100, paddingBottom: 50 },
                ]}
              >
                <Text
                  style={{
        ...
        <Modal isVisible={teachUserExArticleTemplate} style={{ zIndex: 1 }}>
          <TouchableWithoutFeedback
            onPress={() => {
              this.props.setTeachUserExArticleTemplate(
                user && user.user_id,
                "false"
              );
              this.props.setTeachUserExerciseProgram(
                user && user.user_id,
                "true"
              );
            ...
            style={{
              ...
              marginTop:
                isHeight < 569
                  ...
                  ? headingMarginTop - 6
                  : headingMarginTop -
                    25 /* marginTop: Platform.OS === 'android' ? "36%" : isNotchDevice ? "33.1%" : "35%" */,
            }}
          >
            <View
              style={{
              ...
              >
                <TouchableWithoutFeedback
                  onPress={() => {
                    ...
                    if (stipTeach == 1) {
                      this.props.setTeachUserExercise(
                        user && user.user_id,
                        "true"
                      );
