...
import {
  ...
  setTeachUserExercise,
  getTeachUserExArtTemp,
  setTeachUserExArticleTemplate,
  getTeachUserExerciseProgram,
  setTeachUserExerciseProgram,
} from "../../redux/get";
...
const Exercise = ({ navigation }) => {
  ...
  const {
    ...
    statusAllTrainingSet,
    allTrainingSet,
    statusTrainingSet,
    trainingSet,
  } = useSelector(({ getData }) => (getData ? getData : ""));
  const { statusPopupSary } = useSelector(({ updateData }) =>
    updateData ? updateData : ""
  );
  const { coreBalanceRoute } = useSelector(({ personalDataUser }) =>
    personalDataUser ? personalDataUser : ""
  );
  const { set_Selected_Tab } = useSelector(({ personalDataUser }) =>
    personalDataUser && personalDataUser ? personalDataUser : null
  );
  ...
  const teachUserExercise = useSelector(({ getData }) =>
    getData ? getData.teachUserExercise : false
  );
  const statusTeachUserExercise = useSelector(({ getData }) =>
    getData ? getData.statusTeachUserExercise : false
  );
  ...
  const Max_Header_Height =
    deviceHeight <= 667
      ? deviceHeight - 256
      : deviceHeight >= 668 && deviceHeight <= 736
      ? deviceHeight - 156
      : deviceHeight >= 737 && deviceHeight <= 800
      ? deviceHeight - 246
      : deviceHeight >= 801 && deviceHeight <= 844
      ? deviceHeight - 286
      : deviceHeight >= 845 && deviceHeight <= 926
      ? deviceHeight - 326
      : deviceHeight - 276;
  ...
  const clickProgram = () => {
    ...
    setTimeout(() => {
      navigation.navigate("ExProgram", {
        status_male_female: status_male_female,
        category: group,
  ...
  const videoPlay = () => {
    return (
      <View
        style={{ position: "relative", width: 375, alignItems: "flex-end" }}
      >
        <Pressable
          onPress={() => closeeModalPlayExample()}
  ...
  const program = () => {
    ...
    return (
      <>
        <View
          style={[styles.centeredVedio, { marginTop: play == true ? 0 : 150 }]}
        >
            ...
            <View style={styles.boxModel}>
              ...
              >
                <Image
                  ...
                  source={
                    group === "core_balance_plyo" || group === "core_balance"
                      ? require("../../assets/images/cover_page/core_balance.jpg")
                      : group === "flexibility"
                      ? require("../../assets/images/cover_page/flexibility.jpg")
                      : status_resistance === "ยิม" &&
                        status_male_female === "ชาย"
                      ? require("../../assets/images/cover_page/resistance.jpg")
                      : status_resistance === "ยิม" &&
                        status_male_female === "หญิง"
                      ? require("../../assets/images/cover_page/resistance_Female.jpg")
                      : status_resistance === "ดัมเบล" &&
                        status_male_female === "ชาย"
                      ? require("../../assets/images/cover_page/goblet_Squat.jpg")
                      : status_resistance === "ดัมเบล" &&
                        status_male_female === "หญิง"
                      ? require("../../assets/images/cover_page/goblet_Squat_Female.jpg")
                      : status_resistance === "ตัวเปล่า" &&
                        status_male_female === "ชาย"
                      ? require("../../assets/images/cover_page/core_balance_plyo.jpg")
                      : status_resistance === "ตัวเปล่า" &&
                        status_male_female === "หญิง" &&
                        require("../../assets/images/cover_page/core_balance_plyo_Female.jpg")
                  }
                />
                <View
                  style={{
                  ...
                  <Pressable onPress={() => closeeModal()}>
                    <Image
                      ...
                      source={
                        status_resistance !== "ตัวเปล่า" &&
                        group === "resistance"
                          ? require("../../assets/images/icon/close_white.png")
                          : require("../../assets/images/exercise/close_button.png")
                      }
                    />
                  </Pressable>
                </View>
                ...
                >
                  ...
                  <View style={{ flexDirection: "row", marginTop: 16 }}>
                    ...
                    {groupName != "Resistance" && (
                      <View
                        style={{ flexDirection: "row" /*  marginLeft: 37 */ }}
                      >
                        <Image
                          style={{
                            height: 16,
                    ...
                    <View>
                      <View style={styles.missionView}>
                        <Pressable
                          ...
                          onPress={() => setStatus_male_female("ชาย")}
                        >
                          <Text
                            style={[
                              styles.mission,
                        ...
                        {group === "resistance" && (
                          <Pressable
                            Pressable
                            style={[
                              { marginLeft: 8, width: 71 },
                              status_male_female === "หญิง"
                                ? styles.missionPre
                                : styles.programPre,
                            ]}
                            onPress={() => setStatus_male_female("หญิง")}
                          >
                            <Text
                              style={[
                                styles.mission,
                      ...
                      <View>
                        <View style={styles.missionView}>
                          ...
                          <Pressable
                            ...
                            onPress={() => statusResistance("ดัมเบล")}
                          >
                            <Text
                              style={[
                                styles.mission,
                          ...
                          <Pressable
                            ...
                            onPress={() => statusResistance("ตัวเปล่า")}
                          >
                            <Text
                              style={[
                                styles.mission,
        ...
        <View style={styles.boxSub}>
          <Pressable onPress={() => clickProgram()}>
            <View style={ComponentsStyle.button}>
              <Text style={ComponentsStyle.textButton}>{t("start_exe")}</Text>
            </View>
          </Pressable>
        </View>
      </>
  ...
  const result =
    exerciserActivity &&
    exerciserActivity.some((item) => item.read_article === null);
    ...
    <View style={styles.fill}>
          ...
          <View style={styles.missionText}>
            <View style={styles.missionView}>
              ...
              <Pressable
                ...
                onPress={() => setStatusMission(false)}
              >
                <Text
                  style={[
                    styles.mission,
                ...
                {exerciserActivity && exerciserActivity.length > 0 ? (
                  ...
                  >
                    <Image
                      ...
                      source={
                        result && result == true
                          ? require("../../assets/images/icon/History_unread.png")
              ...
              {statusMission === true ? (
                <>
                  {exerciserActivity ? (
                    exerciserActivity.map((item, i) => {
                      if (
                        item.status_mission_activities !== "completed" &&
                        item.week_in_program == week_program_user
                      ) {
                        return (
                          <Pressable
                            onPress={() =>
                              navigation.navigate("ExArticleTemplate", {
                                ...
                                heading:
                                  i18next.language === "th"
                                    ? item.heading
                                    : item.heading_eng,
                                mission_activities: item.mission_activities,
                                statusPags: "Exercise",
                              })
                            }
                            key={i + "tfb"}
                          >
                            <View key={i} style={styles.row}>
                              ...
                              <View style={styles.missionData}>
                                ...
                                ) : item.quiz_activities_number == null &&
                                  week_program_user != item.week_in_program ? (
                  ...
                  {allTrainingSet ? (
                    ...
                    allTrainingSet.map((item, i) => {
                      return (
                        <Pressable
                          key={i + "vp"}
                          onPress={() => closeeModal(item.id, item.name)}
                        >
                          <View key={i + "vd"} style={styles.rowProgram}>
                            <View
                              style={styles.imageProgramView}
                              key={i + "vd2"}
                            >
                              <Image
                                style={{
          ...
          <TouchableWithoutFeedback onPress={() => setModalVisibleEx(false)}>
            <View style={styles.centeredView}>
              <View style={styles.centeredView2}>
                <Text style={styles.textHeadWeek}>
                  {t("last_weeks")} {week_program_user - 1}{" "}
                </Text>
                <Image
                  style={{ width: 160, height: 160 }}
                  source={
                    checkTrophy(weekStaryMission, weekStaryLevel) == 1 &&
                ...
                {checkStar(weekStaryMission, weekStaryLevel) == 0 ? (
                  ...
                  <>
                    ...
                    <Text style={styles.textStar2}>
                      {t("complete_the_mission")}
                    </Text>
                  </>
                ) : checkStar(weekStaryMission, weekStaryLevel) == 3 ? (
                  <>
      ...
      <View style={styles.centeredView}>
        ...
        >
          ...
          {isModalVisibleExVideo === true ? (
            <>
              <View style={styles.boxPlay2}>{videoPlay()}</View>
              <View style={[styles.boxPlay]}></View>
            </>
          ) : null}
        </Modal>
      </View>
      ...
      <Modal isVisible={teachUserExercise} style={{ zIndex: 1 }}>
        <TouchableWithoutFeedback
          onPress={() => {
            dispatch(
              setTeachUserExArticleTemplate(user && user.user_id, "false")
            );
                  ...
                  onPress={() =>
                    ...
                    exerciserActivity.map((item, i) => {
                      if (i == 0) {
                        ...
                        dispatch(
                          setTeachUserExercise(user && user.user_id, "false")
                        );
                      }
                    })
                  }
              ...
              style={[
                {
                  ...
                  marginTop:
                    isDevice < 569
                      ? 350
                      : isDevice > 568 && isDevice < 897
                      ? 330
                      : isDevice > 896 && isDevice < 927
                      ? 320
                      : 460,
            ...
            >
              ...
              <View
                style={{
                  justifyContent: "flex-end",
                  flex: 1,
                  alignItems: isDevice > 926 ? "flex-start" : "center",
                  marginLeft: isDevice > 926 && 80,
                  marginTop: 60,
                }}
              >
                <Image
                ...
                <View
                  style={{
                    ...
                    marginBottom:
                      isDevice < 569 ? 30 : isDevice > 926 ? 140 : 10,
                    borderRadius: 16,
                    paddingTop: 16,
                    paddingHorizontal: 16,
                  }}
