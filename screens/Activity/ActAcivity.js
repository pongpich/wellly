...
class ActAcivity extends Component {
  ...
  componentDidMount() {
    this._unsubscribe = this.props.navigation.addListener("focus", () => {
      ...
      const { activity, intensity, type, duration, note } =
      ...
      <View style={styles.fill}>
          ...
          <Modal isVisible={isModalVisible2} style={{ margin: 0 }}>
            ...
            >
              <View style={styles.modalView}>
                <Text style={styles.headModal}>
                  แน่ใจที่ลบกิจกรรมนี้หรือไม่
                </Text>
                <View
                  style={[
                    styles.missionView,
        ...
        <View>
          <Pressable
            ...
            onPress={() => this.toggleModal(isModalVisible2)}
          />
          <Modal isVisible={isModalConter2} style={{ margin: 0 }}>
            <View
              style={{ flex: 1, justifyContent: "flex-end" }}
              onPress={() => this.toggleModal(isModalVisible2)}
            >
              <View style={styles.modalViewConter}>
                ...
                >
                  <TouchableWithoutFeedback
                    onPress={() => this.isModalConter(isModalConter2)}
                  >
                    <Image
                      style={styles.cross}
