...
import {
  validatePersonalAge,
  validatePersonalWeight,
  validatePersonalHeight,
} from "../constants/functionComponents";
...
class PersonalData extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.statusUpdatePersonalData !== statusUpdatePersonalData &&
  ...
  onNextInput() {
    ...
    if (isFocusedHeight) {
    } //ไม่ต้องทำอะไรเพราะอยู่ inputตัวสุดท้ายแล้ว
  }
  ...
  onPreviousInput() {
    ...
    if (isFocusedAge) {
    } //ไม่ต้องทำอะไรเพราะอยู่ inputตัวแรกสุด
    if (isFocusedWeight) {
              ...
              <View>
                ...
                <View style={styles.radioFormView}>
                  <View style={styles.radioFormIcon}>
                    <TouchableWithoutFeedback
                      onPress={() => this.handleFocus("sex", "male")}
                    >
                      <Image
                        style={styles.iconRadio}
                        source={
                          sex == "ชาย" || sex == "male"
                            ? require("../assets/images/icon/radioActive.png")
                            : require("../assets/images/icon/radio.png")
                        }
                      />
                    </TouchableWithoutFeedback>
                  ...
                  <View style={styles.radioFormIcon2}>
                    <TouchableWithoutFeedback
                      onPress={() => this.handleFocus("sex", "female")}
                    >
                      <Image
                        style={styles.iconRadio}
                        source={
                ...
                <View style={styles.viewRightTnput}>
                      ...
                      <View style={styles.inputAccessory}>
                        ...
                        <View>
                          <Pressable onPress={Keyboard.dismiss}>
                            <Text style={styles.textDoneButton}>
                              {t("finish")}
                            </Text>
                          </Pressable>
                        </View>
                  ...
                  {statusTextAge === 0 ? (
                    <Text style={ComponentsStyle.textError}>
                      {t("please_fill_truth")}
                    </Text>
                  ) : statusTextAge === 1 ? (
                    <Text style={ComponentsStyle.textError}>
                ...
                <View style={styles.viewRightTnput}>
                  ...
                  <TextInput
                    onFocus={(text) =>
                      this.handleFocus("isFocusedWeight", true)
                    }
                    onBlur={(text) => this.outHandleBlur1()}
                    style={
                      statusWeight === true
                        ? isFocusedWeight === true
                          ? ComponentsStyle.inputIsFocused
                          : ComponentsStyle.input
                        : ComponentsStyle.inputError
                    }
                  ...
                  {statusTextWeight === 0 ? (
                    <Text style={ComponentsStyle.textError}>
                      {t("please_enter_value_1")}
                    </Text>
                  ) : statusTextWeight === 1 ? (
                    <Text style={ComponentsStyle.textError}>
                      {t("weight_between_30_250")}
                    </Text>
                  ) : null}
                </View>
                ...
                <View style={styles.viewRightTnput}>
                  ...
                  <TextInput
                    onFocus={(text) =>
                      this.handleFocus("isFocusedHeight", true)
                    }
                    onBlur={(text) => this.outHandleBlur2()}
                    style={
                      statusHeight === true
                        ? isFocusedHeight === true
                          ? ComponentsStyle.inputIsFocused
                          : ComponentsStyle.input
                        : ComponentsStyle.inputError
                    }
                  ...
                  {statusTextHeight === 0 ? (
                    <Text style={ComponentsStyle.textError}>
                      {t("please_enter_value_100")}
                    </Text>
                  ) : statusTextHeight === 1 ? (
                    <Text style={ComponentsStyle.textError}>
                      {t("height_between_100_280")}
                    </Text>
                  ) : null}
                </View>
                ...
                <View style={styles.radioFormView}>
                  <View style={styles.radioFormIcon}>
                    <TouchableWithoutFeedback
                      onPress={() => this.handleFocus("exercise", "always")}
                    >
                      <Image
                        style={styles.iconRadio}
                        source={
                  ...
                  <View style={styles.radioFormIcon2}>
                    <TouchableWithoutFeedback
                      onPress={() => this.handleFocus("exercise", "sometimes")}
                    >
                      <Image
                        style={styles.iconRadio}
                        source={
                  ...
                  <View style={styles.radioFormIcon2}>
                    <TouchableWithoutFeedback
                      onPress={() => this.handleFocus("exercise", "not at all")}
                    >
                      <Image
                        style={styles.iconRadio}
                        source={
